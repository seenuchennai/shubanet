...
namespace AmiBroker.Samples.YahooDataSource
{
    ...
    internal static class LogAndMessage
    {
        ...
        internal static void Log(MessageType type, string message, TickerData tickerData)
        {
            if (IsLoggable(type))
            {
                if (tickerData == null)
                    ...
                    Log(type, tickerData.Ticker + ": " + message);
            }
        }
        ...
        internal static void LogAndAdd(MessageType type, string message, TickerData tickerData)
        {
            if (IsLoggable(type))
            {
                if (tickerData == null)
                ...
                {
                    QueueMessage(type, tickerData.Ticker + ": " + message);
                    Log(type, tickerData.Ticker + ": " + message);
                }
            }
        }
